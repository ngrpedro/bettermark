...
import pdf3 from '../assets/pdf/SEO-Dogotal Marketing.pdf'
import pdf4 from '../assets/pdf/SEO-Dogotal Marketing.pdf'
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5'>
            <div className='border border-gray-200 rounded-lg flex flex-col items-start 
                ...
                <div className='w-full relative'>
                    <img src={salon} alt="" className='rounded-t-lg w-full h-52 object-cover
            ...
            <div className='border border-gray-200 rounded-lg flex flex-col items-start 
                                                hover:shadow-md transition-all group'>
                <div className='w-full relative'>
                    <img src={marketing} alt="" className='rounded-t-lg w-full h-52 object-cover
                                                group-hover:opacity-30 transition-all ' />
                    <div className='hidden group-hover:block transition-all' style={{
                        position: "absolute",
                        top: "50%",
            ...
            <div className='border border-gray-200 rounded-lg flex flex-col items-start 
                                                hover:shadow-md transition-all group'>
                <div className='w-full relative'>
                    <img src={engineering} alt="" className='rounded-t-lg w-full h-52 object-cover
                                                group-hover:opacity-30 transition-all ' />
                    <div className='hidden group-hover:block transition-all' style={{
                        position: "absolute",
                        top: "50%",
            ...
            <div className='border border-gray-200 rounded-lg flex flex-col items-start 
                                                hover:shadow-md transition-all group'>
                <div className='w-full relative'>
                    <img src={male} alt="" className='rounded-t-lg w-full h-52 object-cover
                                                group-hover:opacity-30 transition-all ' />
                    <div className='hidden group-hover:block transition-all' style={{
                        position: "absolute",
                        top: "50%",
