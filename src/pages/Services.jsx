                    ...
                    <TabPanels>
                        <TabPanel>
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-10 pt-9'>
                                <div className='flex flex-col items-start justify-start gap-3 md:border-r border-gray-300'>
                                    <div className='p-3 rounded-md bg-[#e8d7ff]'>
                                ...
                                <div className='flex flex-col items-start justify-start gap-3'>
                                    <div className='p-3 rounded-md bg-[#d8f9cc]'>
                                        <Textbox size={32} />
                                    </div>
                                ...
                                <div className='md:col-span-2 flex flex-col items-start justify-start gap-3 md:pb-10'>
                                    <div className='p-3 rounded-md bg-[#fff6d7]'>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7">
                                ...
                                <div className='flex flex-col items-start justify-start gap-3 md:border-r border-gray-300'>
                                    <div className='p-3 rounded-md bg-[#E3E9FF]'>
                                ...
                                <div className='flex flex-col items-start justify-start gap-3'>
                                    <div className='p-3 rounded-md bg-[#FFE3F9]'>
